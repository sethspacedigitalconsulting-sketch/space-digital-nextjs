...
export function MagneticText({ text, hoverText, className }: MagneticTextProps) {
    ...
    return (
        ...
        >
            ...
            <span className="text-white font-bold tracking-tighter block whitespace-nowrap">{text}</span>

            {/* Morphing liquid background lens window */}
            <div
                ref={circleRef}
                className="absolute top-0 left-0 pointer-events-none rounded-full bg-[#FF6B2B] overflow-hidden flex items-center justify-center"
                style={{
            ...
            >
                ...
                >
                    <span className="font-bold tracking-tighter text-zinc-950 whitespace-nowrap">
                        {hoverText || text}
                    </span>
                </div>
            </div>
