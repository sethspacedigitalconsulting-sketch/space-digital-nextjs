...
export function Works() {
  ...
  useEffect(() => {
    ...
    const lerp = () => {
      ...
      if (Math.abs(targetX - currentX) < 0.1 && Math.abs(targetY - currentY) < 0.1 && !isActive) {
        rafId = null;
        return;
      }
            ...
            <li key={item.id} className="work-item group flex flex-col">
              ...
              >
                ...
                <div className="flex items-center min-w-0">
                  <h3 className="work-name truncate">
                ...
                <span className="work-tag hidden md:inline text-right">{item.tag}</span>
